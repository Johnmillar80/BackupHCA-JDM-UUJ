...
<table border="1" cellpadding="2" width="900">
	<tr>
		...
		<form action="book.php" method="post">
			...
			<p><input checked="checked" name="item" type="radio" value="MentalHealth" />Mental Health
			| <input name="item" type="radio" value="FinancialHealth" />Financial Health
			| <input name="item" type="radio" value="EmotionalHealth" />Emotional Health
			
			<table style="width: 70%">
				<tr>
					<td>Unique id:</td>
					<td> <input maxlength="50" name="unique_id" required="" type="text" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
...
function draw_calendar($month,$year){
	...
	// Create connection
	$conn = mysqli_connect("localhost","root","","health_chat_anonymous");
		...
		$calendar.= '<td class="calendar-day">';
    		...
    		if (mysqli_num_rows($result) > 0) {
    			...
    			while($row = mysqli_fetch_assoc($result)) {
    				...
    				$calendar .= "<b>" . $row["item"] . "</b><br>ID: " . $row["id"] . "<br>" . $row["unique_id"] . "<br>";
